...
public class FleetManager : MonoBehaviour
{
    ...
    void ShipDataInit()
    {
        ...
        shipInfoDatas[5].DataSet(5, "M", ship_Class.Frigate, 3200, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[6].DataSet(6, "N", ship_Class.Destroyer, 6400, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[7].DataSet(7, "O", ship_Class.Destroyer, 12800, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[8].DataSet(8, "P", ship_Class.Destroyer, 25600, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[9].DataSet(9, "Q", ship_Class.Destroyer, 51200, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[10].DataSet(10, "R", ship_Class.Light_Cruiser, 102400, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[11].DataSet(11, "S", ship_Class.Light_Cruiser, 204800, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[12].DataSet(12, "T", ship_Class.Light_Cruiser, 409600, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[13].DataSet(13, "U", ship_Class.Light_Cruiser, 819200, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[14].DataSet(14, "V", ship_Class.heavy_cruiser, 1638400, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[15].DataSet(15, "W", ship_Class.heavy_cruiser, 3276800, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[16].DataSet(16, "X", ship_Class.heavy_cruiser, 6553600, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[17].DataSet(17, "Y", ship_Class.Battleship, 13107200, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[18].DataSet(18, "Z", ship_Class.Battleship, 26214400, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
        shipInfoDatas[19].DataSet(19, "A", ship_Class.Battleship, 52428800, 10, dmg_Type.particle, 1, 10, 5, 7, 100, 1, 100, 30, 20);
    }
}
...
public class ShipInfoData
{
    ...
    public void DataSet(int id, string shipName, ship_Class ship_Class, int cost, float dmg, dmg_Type dmg_Type, float fireDelay, float maxRange, float minRange, float fitRange, float hp, 
